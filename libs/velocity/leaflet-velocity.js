...
L.Control.Velocity = L.Control.extend({
  ...
  _onMouseMove: function _onMouseMove(e) {
    ...
    if (gridValue && !isNaN(gridValue[0]) && !isNaN(gridValue[1]) && gridValue[2]) {
      ...
      var wind_d = self.vectorToDegrees(gridValue[0], gridValue[1], this.options.angleConvention).toFixed(0);
      var wind_ddd = ( '000' + wind_d ).slice(-3);
      var wind_s_ms = self.vectorToSpeed(gridValue[0], gridValue[1], this.options.speedUnit).toFixed(0);
      var wind_s_kt = Math.ceil(wind_s_ms * 1.944);
      if (wind_s_kt < 10){
        wind_s_kt = ('0' + wind_s_kt)
      }
      htmlOut = "Wind: " + wind_ddd + "° " + wind_s_kt + "KT";
    } else {
      //htmlOut = this.options.emptyString;
      htmlOut = "Wind: No Data";
    }
...
var Windy = function Windy(params) {
  ...
  var PARTICLE_LINE_WIDTH = params.lineWidth || 3.0; // line width of a drawn particle
  ...
  var defaulColorScale = ["rgb(255,255,255)", "rgb(238,247,217)", "rgb(255,238,159)", "rgb(252,217,125)", "rgb(255,182,100)", "rgb(252,150,75)", "rgb(250,112,52)", "rgb(245,64,32)", "rgb(237,45,28)", "rgb(220,24,32)", "rgb(180,0,35)"];
